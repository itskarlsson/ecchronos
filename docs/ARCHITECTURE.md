...
There is also the possibility of letting ecChronos create an internal history table which would handle environments where
IP addresses of nodes are constantly changing.
